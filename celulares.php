...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="row mt-5 mb-3">
            <div class="col-4">
                <form action="celulares.php" method="POST">
                    ...
                    <select id="filtro" name="filtro" class="form-select" required>
                        ...
                        <option name="filtro" value="filtro5">Marca Motorola</option>
                        <option name="filtro" value="filtro6">Marca Samsung</option>
                        <option name="filtro" value="filtro7">Marca Xiaomi</option>
    ...
    if(isset($_POST['filtro'])){
        ...
        if($_POST['filtro']=='filtro1'){
            ...
            global $query;
            $query = query_t_p_findByMarcaTipo($tipo,'Motorola');
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mt-2 mb-5">
                    ...
                    <div class="card-footer d-flex justify-content-between bg-dark border">
                        ...
                        <!-- <a href="#exito" class="btn btn-sm text-light p-0"><i
                                class="fas fa-shopping-cart text-primary mr-1"></i>Añadir a carrito
                        </a> --> <?php }else{
