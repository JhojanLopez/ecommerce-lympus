...
<div class="container py-3">
  ...
  <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
    <h1 class="display-4 fw-normal">Planes postpago</h1>
    <p class="fs-5 text-muted">Tenemos muchos paquetes para que puedas navegar, hablar y disfrutar con las personas que mas quieres. 
  ...
  <main>
    ...
    <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">$55000<small class="text-muted fw-light">/mes</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              ...
              <li>Claro música, Claro video y Claro drive incluidos.</li>
            </ul>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">$65000<small class="text-muted fw-light">/mes</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>Minutos y mensajes ilimitados.</li>
              <li>Instagram, Twitter, Facebook y WhatsApp ilimitados.</li>
              <li>500 minutos para llamadas a larga distancia internacional.</li>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">$70000<small class="text-muted fw-light">/mes</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>Minutos y mensajes ilimitados.</li>
              <li>Instagram, Twitter, Facebook y WhatsApp ilimitados.</li>
              <li>500 minutos para llamadas a larga distancia internacional.</li>
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">$100000<small class="text-muted fw-light">/mes</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>Minutos y mensajes ilimitados.</li>
              <li>Instagram, Twitter, Facebook y WhatsApp ilimitados.</li>
              <li>500 minutos para llamadas a larga distancia internacional.</li>
