...
<body>
                    ...
                    <div id="carouselExampleDark" class="carousel carousel-dark slide mt-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active" data-bs-interval="10000">
                                <img src="img/imgGrandes/Computadores/principal/computador_principal1.png" class="d-block w-100" alt="productos" width="1279" height="475"/>
            ...
            <div class="col-4">
                <form action="computadores.php" method="POST">
                    ...
                    <select id="filtro" name="filtro" class="form-select" required>
                        ...
                        <option name="filtro" value="filtro4">Marca Apple</option>
                        <option name="filtro" value="filtro5">Marca Asus</option>
                        <option name="filtro" value="filtro6">Marca Lenovo</option>
                        <option name="filtro" value="filtro7">Marca HP</option>
    ...
    if(isset($_POST['filtro'])){
        ...
        if($_POST['filtro']=='filtro1'){
            ...
            global $query;
            $query = query_t_p_findByMarcaTipo($tipo,'Apple');

        }else if($_POST['filtro']=='filtro5'){
            global $query;
            $query = query_t_p_findByMarcaTipo($tipo,'Asus');

        }else if($_POST['filtro']=='filtro6'){
            global $query;
            $query = query_t_p_findByMarcaTipo($tipo,'Lenovo');

        }else if($_POST['filtro']=='filtro7'){
            global $query;
            $query = query_t_p_findByMarcaTipo($tipo,'HP');
        ...
        while($row=mysqli_fetch_assoc($result))
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mt-2 mb-5">
                    ...
                    <img class="img-fluid imagen-tienda" 
                        src="<?php  echo $row["imagen"];?>" alt="<?php  echo 'foto_'.$row["nombre"];?>">
                    </div>
                    ...
                    <div class="card-footer d-flex justify-content-between bg-dark border">
                        ...
                        <?php if(isset($_SESSION['rol'])){?>
                            ...
                            <input type="hidden" name="redireccion" value="3">
